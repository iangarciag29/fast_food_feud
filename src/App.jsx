        ...
        <main className="App">
            <div className="CategoriesColumn col">
                <div className="categories options">
                    ...
                    {categories.map((category, idx) => <Chip key={idx}
                                                             label={category}
            ...
            <div className="container">
                ...
                <div className="RestaurantsRow">
                    ...
                    <div className="restaurants options">
                        {restaurants.map((restaurant, idx) => <Chip key={idx}
                                                                    label={restaurant}
                ...
                <div className="MenuDisplay display">
                    <div className="MenuItemButtons menu-items">
                        ...
                        {currentMenuItems.map((item, idx) => <Chip label={item.item_name} key={idx}
                                                                   isActive={selectedMenuItem === item}
                                                                   onClick={() => setSelectedMenuItem(item)}/>)}
                    </div>

                    {selectedMenuItem && <div className="NutritionFacts nutrition-facts">
